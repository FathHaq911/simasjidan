						...
						<form action="{{ route('kajian.update', $item->id) }}" method="post">
							...
							<div class="relative">
								...
								<div>
									...
									<input id="title" class="w-full mb-20 border-0 focus:ring-transparent placeholder-slate-400 appearance-none py-3 pl-10 pr-4 border-b border-slate-200" type="text" placeholder="Rp" name="title" value="{{ $item->title }}" />
								</div>
								<div>
									<label for="label" class="mb-5">Tanggal</label>
									<input id="label" class="w-full mb-20 border-0 focus:ring-transparent placeholder-slate-400 appearance-none py-3 pl-10 pr-4 border-b border-slate-200" type="date" placeholder="Beri Keterangan" name="label" value="11/20/2022" />
								</div>
							</div>
						</form>
					</div>
