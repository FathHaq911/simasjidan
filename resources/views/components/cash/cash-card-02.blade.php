<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
    <div class="px-5 pt-5">
        ...
        <h2 class="text-lg font-semibold text-slate-800 mb-2">Total Pemasukan</h2>
        <div class="text-xs font-semibold text-slate-400 uppercase mb-1">Majsid Al-Barkah</div>
        <div class="flex items-start">
            <div class="text-3xl font-bold text-slate-800 mr-2">Rp {{ number_format($t_debit, 0, ",", ".") }}</div>
