<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
    <div class="px-5 pt-5">
        <header class="flex justify-end items-start mb-5">
            <!-- Menu button -->
        ...
        <h2 class="text-lg font-semibold text-slate-800 mb-2">Total Pengeluaran</h2>
        <div class="text-xs font-semibold text-slate-400 uppercase mb-1">Majid Al-Barkah</div>
        <div class="flex items-start">
            <div class="text-3xl font-bold text-slate-800 mr-2">Rp {{ number_format($t_kredit, 0, ",", ".") }}</div>
