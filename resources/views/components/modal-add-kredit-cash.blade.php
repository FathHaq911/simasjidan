...
<div x-data="{ searchOpen: false }">
	...
	>
		...
		<span class="hidden xs:block ml-2">Pengeluaran</span>
	</button>	
	<!-- Modal backdrop -->
	<div
				...
				<div class="p-10">
					<form action="{{ route('cash.store') }}" method="POST">
						...
						<div class="relative">
							...
							<div>
								<label for="uang" class="">Pengeluaran</label>
								<input id="uang" class="w-full border-0 focus:ring-transparent placeholder-slate-400 appearance-none py-3 pl-10 pr-4 border-b border-slate-200" type="text" placeholder="Rp" name="kredit" />
							</div>
							<div>
